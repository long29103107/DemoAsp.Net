...
namespace DoanRapphim.Migrations
{
    ...
    [Migration("20201220041937_update_rapchieuphim")]
    partial class update_rapchieuphim
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoanRapphim.Areas.Admin.Models.GheModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoanRapphim.Areas.Admin.Models.VeModel", b =>
                {
                    b.HasOne("DoanRapphim.Areas.Admin.Models.GheModel", "Ghe")
                        .WithMany()
                        .HasForeignKey("IdGhe")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
